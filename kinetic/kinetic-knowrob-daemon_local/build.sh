...
NAMES="knowrob knowrob_addons iai_maps iai_common_msgs iai_cad_tools mjpeg_server"
...
clone_knowrob() {
  clone_knowrob_repo knowrob            https://github.com/knowrob/knowrob.git           kinetic
  clone_knowrob_repo knowrob_addons     https://github.com/knowrob/knowrob_addons.git    kinetic
  ...
  clone_knowrob_repo mjpeg_server   https://github.com/RobotWebTools/mjpeg_server.git    master  
}
...
docker build -t openease/kinetic-knowrob-daemon .
